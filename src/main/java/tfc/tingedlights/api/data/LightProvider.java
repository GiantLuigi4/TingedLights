...
public abstract class LightProvider {
	 ...
	 * It also determines the color and brightness of said light
	 *
	 ...
	 */
	public abstract Light createLight(BlockState pState, Level pLevel, BlockPos pPos);
	 ...
	 */
	public abstract boolean providesLight(BlockState pState, Level pLevel, BlockPos pPos);
